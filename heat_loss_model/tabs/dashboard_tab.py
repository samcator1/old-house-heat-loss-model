...
def build_dashboard_tab(ss: gspread.Spreadsheet) -> Tuple[gspread.Worksheet, List[Dict[str, Any]]]:
    ...
    grid[3][0] = "='2_Room_Heat_Loss'!$AF$28/1000"
    grid[4][0] = "=TEXT('2_Room_Heat_Loss'!$AG$28, \"0.0\") & \" W/m² whole-house average\""
    ...
    for z_idx, z in enumerate(DEFAULT_ZONES):
        ...
        grid[dash_r][4] = f"=SUMIF('2_Room_Heat_Loss'!$D$5:$D$27, A{dash_r+1}, '2_Room_Heat_Loss'!$AF$5:$AF$27)/1000"
    ...
    grid[29][4] = "='2_Room_Heat_Loss'!$AF$28/1000"
    grid[29][5] = "=SUM(F24:F29)"
    grid[29][6] = "='2_Room_Heat_Loss'!$AG$28"
