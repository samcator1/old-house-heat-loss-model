...
def build_systems_tab(ss: gspread.Spreadsheet) -> Tuple[gspread.Worksheet, List[Dict[str, Any]]]:
    ...
    grid[4] = [
        ...
        "=(('2_Room_Heat_Loss'!$AE$28/('2_Room_Heat_Loss'!$E$28-'1_Inputs'!$C$5))*'1_Inputs'!$C$7*24/1000)*'1_Inputs'!$C$8",
        "=B5/$B$8",
    ...
    grid[12] = [
        ...
        "=(('2_Room_Heat_Loss'!$AE$28/1000)*(1+'1_Inputs'!$C$16))",
        "kW heat",
        "='1_Inputs'!$C$64",
        "=B13*D13",
    ...
    grid[14] = [
        ...
        "=(('2_Room_Heat_Loss'!$AE$28/1000)*(1+'1_Inputs'!$C$17))",
        "kW heat",
        "='1_Inputs'!$C$66",
        "=B15*D15",
