...
INPUT_DEFINITIONS: List[Dict[str, Any]] = [
    ...
    # Section 8: Chimney & Flue Ventilation Allowances (BS EN 12831 & CIBSE Guide A)
    {"row": 80, "key": "ach_chimney_none", "section": "8. Chimney & Flue Infiltration Rates", "label": "No Chimney / Permanently Sealed", "default": 0.00, "unit": "ACH", "fmt": FORMATS["ACH"], "notes": "No open flue or chimney has been permanently capped/sealed"},
    {"row": 81, "key": "ach_chimney_stove", "section": "8. Chimney & Flue Infiltration Rates", "label": "Room-Sealed Stove with Ext Air", "default": 0.05, "unit": "ACH", "fmt": FORMATS["ACH"], "notes": "Closed woodburner with dedicated direct external combustion air duct"},
    {"row": 82, "key": "ach_chimney_balloon", "section": "8. Chimney & Flue Infiltration Rates", "label": "Flue Damper / Chimney Balloon Fitted", "default": 0.15, "unit": "ACH", "fmt": FORMATS["ACH"], "notes": "Open chimney fitted with inflatable throat balloon or mechanical damper"},
    {"row": 83, "key": "ach_chimney_open", "section": "8. Chimney & Flue Infiltration Rates", "label": "Open Fireplace (Unsealed Flue)", "default": 0.60, "unit": "ACH", "fmt": FORMATS["ACH"], "notes": "Unrestricted open chimney flue driving continuous warm air stack extraction"},
    ...
    {"row": 99, "key": "u_win_single_metal", "ach_key": "ach_win_single_metal", "ach_default": 0.40, "section": "9. Window & Glazing Thermal Transmittance (U-Values)", "label": "Single Glazed (Metal / Crittall / Stone Mullion)", "default": 5.60, "unit": "W/m²K", "fmt": FORMATS["DECIMAL_2"], "notes": "Single glazed in uninsulated steel frame or direct to stone mullion"},
    {"row": 100, "key": "u_win_single_shutters", "ach_key": "ach_win_single_shutters", "ach_default": 0.25, "section": "9. Window & Glazing Thermal Transmittance (U-Values)", "label": "Single Glazed + Heavy Thermal Curtains / Working Shutters", "default": 3.00, "unit": "W/m²K", "fmt": FORMATS["DECIMAL_2"], "notes": "Traditional solid interior wooden shutters closed or heavy thermal interlined curtains"},
    {"row": 101, "key": "u_win_single_sec_std", "ach_key": "ach_win_single_sec_std", "ach_default": 0.10, "section": "9. Window & Glazing Thermal Transmittance (U-Values)", "label": "Single Glazed + Standard Secondary Glazing", "default": 2.60, "unit": "W/m²K", "fmt": FORMATS["DECIMAL_2"], "notes": "Internal secondary glazing pane with >20mm sealed cavity, clear float glass"},
    {"row": 102, "key": "u_win_single_sec_lowe", "ach_key": "ach_win_single_sec_lowe", "ach_default": 0.10, "section": "9. Window & Glazing Thermal Transmittance (U-Values)", "label": "Single Glazed + Low-E Secondary Glazing", "default": 1.80, "unit": "W/m²K", "fmt": FORMATS["DECIMAL_2"], "notes": "Secondary glazing pane with pyrolytic Low-E coating, draught-sealed perimeter"},
    {"row": 103, "key": "u_win_double_slim", "ach_key": "ach_win_double_slim", "ach_default": 0.15, "section": "9. Window & Glazing Thermal Transmittance (U-Values)", "label": "Heritage Slimline Double Glazing (Timber Frame)", "default": 1.90, "unit": "W/m²K", "fmt": FORMATS["DECIMAL_2"], "notes": "Ultra-slim vacuum or Krypton units (6-8mm) fitting traditional historic glazing rebates"},
    {"row": 104, "key": "u_win_double_early", "ach_key": "ach_win_double_early", "ach_default": 0.10, "section": "9. Window & Glazing Thermal Transmittance (U-Values)", "label": "Early Standard Double Glazing (Pre-2002, Air Gap)", "default": 2.80, "unit": "W/m²K", "fmt": FORMATS["DECIMAL_2"], "notes": "1st-generation aluminium spacer double glazing without Low-E coating"},
    {"row": 105, "key": "u_win_double_modern", "ach_key": "ach_win_double_modern", "ach_default": 0.00, "section": "9. Window & Glazing Thermal Transmittance (U-Values)", "label": "Modern Double Glazing (Argon, Low-E, Warm Edge)", "default": 1.40, "unit": "W/m²K", "fmt": FORMATS["DECIMAL_2"], "notes": "Current UK Building Regulations Part L standard domestic double glazing"},
    {"row": 106, "key": "u_win_triple_modern", "ach_key": "ach_win_triple_modern", "ach_default": 0.00, "section": "9. Window & Glazing Thermal Transmittance (U-Values)", "label": "Modern High-Performance Triple Glazing", "default": 0.80, "unit": "W/m²K", "fmt": FORMATS["DECIMAL_2"], "notes": "Passivhaus standard triple glazing with two Low-E coats and warm edge spacer"},
    {"row": 107, "key": "u_win_roof_lantern", "ach_key": "ach_win_roof_lantern", "ach_default": 0.15, "section": "9. Window & Glazing Thermal Transmittance (U-Values)", "label": "Glazed Roof Lantern / Sloping Skylight", "default": 1.80, "unit": "W/m²K", "fmt": FORMATS["DECIMAL_2"], "notes": "Sloping or horizontal glazed orientation with increased internal convective transfer"},
    {"row": 108, "key": "u_win_none", "ach_key": "ach_win_none", "ach_default": 0.00, "section": "9. Window & Glazing Thermal Transmittance (U-Values)", "label": "No External Glazing (Enclosed / Blind Room)", "default": 0.00, "unit": "W/m²K", "fmt": FORMATS["DECIMAL_2"], "notes": "Internal corridors, enclosed cloakrooms, or windowless plantrooms"},
...
SECTION_HEADERS = [
    ...
    {"row": 74, "title": "8. CHIMNEY & FLUE INFILTRATION RATES (ACH)"},
